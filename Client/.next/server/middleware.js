...
function middleware(req) {
  ...
  if (!AdminVerify && url === "http://localhost:3000/Admin") {
    return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.redirect("http://localhost:3000/User");
  }

  if (!UserVerify && url === "http://localhost:3000/User") {
    return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.redirect("http://localhost:3000/Admin");
  }
}
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_js_page_2Fmiddleware_rootDir_C_3A_5CUsers_5CAdmin_5CDesktop_5CSchoolTask_5Cclient_matchers_)
});
...
// EXTERNAL MODULE: ./node_modules/next/dist/compiled/cookie/index.js
var cookie = __webpack_require__(802);
...
const serializeExpiredCookie = (key, options = {})=>cookie_default().serialize(key, "", {
        expires: new Date(0),
        path: "/",
        ...options
    });
...
class Cookies extends Map {
    constructor(input){
        const parsedInput = typeof input === "string" ? cookie_default().parse(input) : {};
        super(Object.entries(parsedInput));
    }
    set(key, value, options = {}) {
        return super.set(key, cookie_default().serialize(key, serializeValue(value), normalizeCookieOptions(options)));
    }
    [Symbol.for("edge-runtime.inspect.custom")]() {
...
class NextCookies extends Cookies {
    ...
    getWithOptions = (...args)=>{
        ...
        const { [args[0]]: value , ...options } = cookie_default().parse(raw);
        return {
            value,
            options
        };
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.js&page=%2Fmiddleware&rootDir=C%3A%5CUsers%5CAdmin%5CDesktop%5CSchoolTask%5Cclient&matchers=!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_js_page_2Fmiddleware_rootDir_C_3A_5CUsers_5CAdmin_5CDesktop_5CSchoolTask_5Cclient_matchers_(opts) {
